...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'docs', loadComponent: () => import('./features/historial/historial.component').then(m => m.HistorialComponent) },
      ...
      // ✅ Migración dentro del layout (tiene sidebar)
      { path: 'migracion', loadComponent: () => import('./features/migracion/migration.component').then(m => m.MigrationComponent) },
    ],
  },
