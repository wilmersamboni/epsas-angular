...
export const CONFIG: Record<Modulo, ModuloConfig> = {
  ...
  matriculas:  { label: 'Matrículas',   idKey: 'id_matricula',  listar: `${BASE}/matricula/listar_jwsv`,   crear: `${BASE}/matricula/registrar_jwsv`,   actualizar: id => `${BASE}/matricula/actualizar_jwsv/${id}`,   eliminar: id => `${BASE}/matricula/eliminar_jwsv/${id}`   },
