...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, RouterLink, AdminLoadingSpinnerComponent],
  template: `
    ...
    <div class="max-w-xl">
      <h1 class="text-xl font-bold text-gray-900 mb-1">{{ modoEdicion() ? 'Editar Dominio' : 'Nuevo Dominio' }}</h1>
      ...
      @if (cargando()) {
        ...
        <form [formGroup]="form" (ngSubmit)="guardar()"
          ...
          <div>
            ...
            <select formControlName="tenantId" class="form-input bg-white">
          ...
          @if (modoEdicion()) {
            <div>
              ...
              <select formControlName="estado" class="form-input bg-white">
