...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, TitleCasePipe, AdminLoadingSpinnerComponent, AdminEmptyStateComponent],
  template: `
    <div class="flex items-center justify-between mb-6">
      <div>
        <h1 class="text-xl font-bold text-gray-900">Gestión de Dominios</h1>
    ...
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 mb-4 flex gap-3">
      ...
      <select class="text-sm px-3 py-2 border border-gray-200 rounded-xl outline-none focus:border-[#39A900] bg-white transition-colors"
