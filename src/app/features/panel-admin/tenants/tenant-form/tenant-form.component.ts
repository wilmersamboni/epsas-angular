  ...
  template: `
    <div class="max-w-3xl mx-auto rounded-3xl p-8">
      <div class="mb-6 mx-auto text-center">
        ...
        <h1 class="text-xl font-bold text-gray-900">{{ modoEdicion() ? 'Editar Centro' : 'Nuevo Centro' }}</h1>
      </div>
            ...
            <div class="p-5 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              @if (modoEdicion()) {
                <div>
                  ...
                  <select formControlName="estado" class="w-full text-sm rounded-xl border border-gray-200 outline-none px-3.5 py-2.5 focus:border-[#39A900] bg-white">
