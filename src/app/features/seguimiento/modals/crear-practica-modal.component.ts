...
//  *
//  * Modo crear  → no pases `practicaId`.
...
//  *               En modo editar, el instructor NO se toca aquí:
//  *               los instructores se gestionan desde "Gestionar asignaciones".
//  */
// @Component({
...
//               @if (modoEditar) {
//                 {{ alumnoPreseleccionado?.name ? alumnoPreseleccionado.name + ' · ' : '' }}Modifica los datos de la etapa práctica
//               } @else {
...
//               <!-- Info del aprendiz preseleccionado (crear o editar) -->
...
//               <!-- ── Aprendiz (solo al crear sin preselección) ── -->
...
//               @if (!modoEditar) {
//                 <tui-textfield tuiTextfieldSize="m">
//                   <label tuiLabel>Instructor responsable <span class="text-gray-400 text-xs">(opcional)</span></label>
//                   <input tuiInput
//                     type="text"
...
//                   <tui-textfield tuiTextfieldSize="m">
//                     <label tuiLabel>Horas asignadas al instructor</label>
//                     <input tuiInput
//                       type="number"
//                       min="1"
//                       [(ngModel)]="form.horasInstructor"
//                       placeholder="Ej: 40"
//                       name="horasInstructor" />
//                   </tui-textfield>
//                 }
//               }
...
//   /** Si se pasa, el modal entra en modo editar y carga esta práctica */
...
//   /** true cuando se recibió un practicaId */
...
//   /* ── Autocomplete instructor (solo en modo crear) ─────────────── */
//   instructorTexto        = '';
...
//   /** Convierte 'YYYY-MM-DD' (o con T) → TuiDay */
...
//   /** Pre-popula el form con los datos de la práctica obtenida del backend */
...
//       fechaInicio: this.isoToTuiDay(practica.fecha_inicio ?? practica.fechaInicio ?? ''),
//       fechaFin:    this.isoToTuiDay(practica.fecha_fin    ?? practica.fechaFin    ?? ''),
//       estado:      practica.estado ?? 'activo',
...
//     };
//     await this.api.actualizarPractica(this.practicaId!, payload);
//   }
...
//       payload.asignacion = {
//         instructor:   String(this.form.instructorId),
//         fecha_inicio: this.tuiDayToISO(this.form.fechaInicio),
//         fecha_fin:    this.tuiDayToISO(this.form.fechaFin),
//         estado:       'activo',
