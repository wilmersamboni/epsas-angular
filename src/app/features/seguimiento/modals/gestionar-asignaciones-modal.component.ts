...
@Component({
  ...
  standalone: true,
  imports: [FormsModule, TuiButton, TuiInputDirective, ...TuiInputDate],
                      ...
                      <div class="border-2 border-indigo-200 rounded-xl p-4 bg-indigo-50/40 flex flex-col gap-3">
                          ...
                          <div class="relative">
                            ...
                            @if (editMostrarLista && instructoresFiltradosEdit().length > 0) {
                              <div class="absolute z-50 w-full bg-white border border-gray-200
                                          rounded-lg shadow-lg max-h-40 overflow-y-auto mt-1">
                        ...
                        <div class="grid grid-cols-3 gap-2">
                          <div>
                            ...
                            <input type="date" [(ngModel)]="a.fecha_inicio" name="fi_{{ a.id }}"
                              class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm
                                     focus:outline-none focus:ring-2 focus:ring-indigo-300" />
                          </div>
                          <div>
                            <label class="text-xs text-gray-500 mb-1 block">Fecha fin</label>
                            <input type="date" [(ngModel)]="a.fecha_fin" name="ff_{{ a.id }}"
                              class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm
                                     focus:outline-none focus:ring-2 focus:ring-indigo-300" />
                          </div>
                          <div>
                ...
                @if (!mostrarFormNuevo()) {
                  ...
                  <div class="border-2 border-[#39A900]/30 rounded-xl p-4 bg-[#39A900]/5 flex flex-col gap-3">
                    ...
                    <div>
                      ...
                      <div class="relative">
                        <input type="text" [value]="nuevoTextoInstructor"
                          ...
                          autocomplete="off"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm
                                 focus:outline-none focus:ring-2 focus:ring-[#39A900]/40" />
                    ...
                    <div class="grid grid-cols-3 gap-2">
                      <div>
                        <label class="text-xs text-gray-500 mb-1 block">Fecha inicio *</label>
                        <input type="date" [(ngModel)]="nuevaAsignacion.fecha_inicio" name="n_fi"
                          class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm
                                 focus:outline-none focus:ring-2 focus:ring-[#39A900]/40" />
                      </div>
                      <div>
                        <label class="text-xs text-gray-500 mb-1 block">Fecha fin *</label>
                        <input type="date" [(ngModel)]="nuevaAsignacion.fecha_fin" name="n_ff"
                          class="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm
                                 focus:outline-none focus:ring-2 focus:ring-[#39A900]/40" />
                      </div>
                      <div>
